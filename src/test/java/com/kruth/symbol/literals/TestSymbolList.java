...
public class TestSymbolList {
    ...
    public void testConstructors() {
        SymbolList objectConstructor = new SymbolList(Arrays.asList((Literal) new SymbolNumber(1), new SymbolNumber(2)));
        assertEquals("Test list constructor", new ArrayList<Literal>(Arrays.asList((Literal) new SymbolNumber(1), new SymbolNumber(2))), objectConstructor.getValue());

        SymbolList stringConstructor = new SymbolList(new InstructionState(), new SpaceLexer("list one sep two sep list"));
        assertEquals("Test list constructor", new ArrayList<Literal>(Arrays.asList((Literal) new SymbolNumber(1), new SymbolNumber(2))), stringConstructor.getValue());
    }
